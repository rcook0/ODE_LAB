...
## v5 Step 5 (Implicit Euler + Newton)
- Added implicit Euler integrator with Newton solve and numeric Jacobian.
- New WASM export: `integrate_model_implicit(model, params, y0, t0, t1, dt, newton_tol, newton_max, jac_eps)`.
- UI solver selector (RK4 vs implicit Euler) + shows basic solver stats.
